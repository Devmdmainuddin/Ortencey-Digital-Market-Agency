...
const Sidebar = ({ searchInput, handleInput,handleTags, categorey,handleCategoryfilter,tags }) => {
    return (
        <div>
            ...
            <div className="p-10 border border-[#FE651B] rounded-[20px] group mt-[50px]">
                ...
                <ul className="flex gap-[18px] flex-wrap mt-10">
                    {tags.map((item,idx)=><li key={idx} onClick={()=>handleTags(item)}><Link href="#" className="text-[#6B6161] bg-[#F4F4FF] font-dm-sans text-[16px] font-normal leading-[26px] py-[7px] px-[20px] rounded-[5px]">{item}</Link></li>)}
